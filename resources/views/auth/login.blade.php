                        ...
                        <div class="card-header ">
                            <div class="logo-container" style="width: 100%;">
                                ...
                                <h2 style="color: #fff; text-align: center;">
                                    <span style="color: #fd7e14;">{{ substr(config('app.name', 'Laravel'),0,1) }}</span>{{ substr(config('app.name', 'Laravel'),1,5) }}
                                    <span style="color: #fd7e14;">{{ substr(config('app.name', 'Laravel'),6,1) }}</span>{{ substr(config('app.name', 'Laravel'),7) }}
                                </h2>
                            </div>
                        </div>
                        <div class="card-body ">
