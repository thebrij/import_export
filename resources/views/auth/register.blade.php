@extends('layouts.app', [
    ...
    'activePage' => 'register',
    'backgroundImage' => asset('assets') . "/img/bg19.jpg",
])
              ...
              <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                  ...
                  <div class="input-group {{ $errors->has('company_name') ? ' has-danger' : '' }}">
                    ...
                    <input class="form-control {{ $errors->has('company_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Company Name') }}" type="text" name="company_name" value="{{ old('company_name') }}" required autofocus>
