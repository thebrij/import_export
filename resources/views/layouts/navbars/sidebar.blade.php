  ...
  <div class="sidebar-wrapper" id="sidebar-wrapper">
    <ul class="nav">
      ...
      <li>
        ...
        <div class="collapse @if ($activePage == 'importerbills' or $activePage == 'exporterbills' or $activePage == 'ImportFiles' or $activePage == 'ExpoterFiles') show @endif" id="imports">
          <ul class="nav">
            ...
            <li class="@if ($activePage == 'exporterbills') active @endif">
              ...
              <li class="@if ($activePage == 'ExpoterFiles') active @endif">
                  <a href="{{ route('exporterbill-files.list') }}">
                      <i class="fas fa-file-upload"></i>
                      <p> {{ __("Expoter Bill Files") }} </p>
                  </a>
              </li>
          </ul>
        </div>
      ...
      <li>
        ...
        <div class="collapse hide" id="hscodes">
          ...
          <ul id="nav_imp_hscode" class="nav">
            ...
            @if(Auth::user()->hasRole('Administrator') or Auth::user()->hasRole('Manager') or Auth::user()->hasRole('Supervisor'))
              @foreach($side_hscode as $hscode)
                <li class="@if ($activePage == $hscode->hs_code) active @endif">
                  <a href="#" class="mmhscode" data-value="{{ $hscode->hs_code }}" style="margin-top: 0px; margin-bottom: 0px; padding-top: 0px; padding-bottom: 0px; padding-left: 15px;">
          ...
          <ul id="nav_exp_hscode" class="nav" style="display: none;">
            ...
            @foreach($side_hscode_ex as $hscode)
                <li class="@if ($activePage == $hscode->hs_code) active @endif">
                  <a href="#" class="mmhscode" data-value="{{ $hscode->hs_code }}" style="margin-top: 0px; margin-bottom: 0px; padding-top: 0px; padding-bottom: 0px; padding-left: 15px;">
                    <i class="fas fa-chevron-circle-right"></i>
                    <p><span>{{ $hscode->hs_code }}</span>  <span>({{ $hscode->order_count }})</span></p>
