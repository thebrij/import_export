              ...
              <div class="pl-lg-4">
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <select id="input-fyear" name="fyear" class="form-control" >
                        <option value="" {{  ("" == old('fyear'))?'selected="selected"':'' }}>Year</option>
                        ...
                        @else--}}
                          @if(isset($da_years) and !empty($da_years))
                            @foreach($da_years as $da_year)
                              <option value="{{ $da_year }}" {{($da_year == old('fyear'))?'selected="selected"':'' }} {{($da_year == date("Y"))?'selected="selected"':'' }}  >{{ $da_year }}</option>
                            @endforeach
                          @endif
                        {{--@endif--}}
                      </select>
                    ...
                    <div class="col-md-2 text-right">
                      ...
                      <button type="reset"  class="btn btn-danger " style="margin: 3px 1px; padding: 10px 10px;">{{ __('Reset') }}</button>
        ...
        {{--<div class="row">
          <div class="col-lg-6 col-md-6">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Port Wise</h5>
                <h4 class="card-title">Market Share by Cost Value in USD</h4>
                <div class="dropdown">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Country Wise</h5>
                <h4 class="card-title">Market Share by Cost Value in USD</h4>
                <div class="dropdown">
                  <button type="button" class="btn btn-round btn-outline-default dropdown-toggle btn-simple btn-icon no-caret" data-toggle="dropdown">
                    <i class="now-ui-icons loader_gear"></i>
...
*/
    ...
    $(document).ready(function() {
        ...
        sessionStorage.setItem("TabName","importer_datatable");
        ...
        $( "#dashboard-tab" ).click(function() {
            sessionStorage.setItem("TabName","importer_dashboard");
            importer_dashboard();
        });
        $( "#impanalysis-tab" ).click(function() {
            sessionStorage.setItem("TabName","importer_analysis");
            importer_analysis();
        });
        $( "#expanalysis-tab" ).click(function() {
            sessionStorage.setItem("TabName","importer_sup_analysis");
            importer_sup_analysis();
        });
        $( "#marketshare-tab" ).click(function() {
            sessionStorage.setItem("TabName","importer_marketshare");
            importer_marketshare();
        });
        $( "#priceana-tab" ).click(function() {
            sessionStorage.setItem("TabName","importer_priceana");
            importer_priceana();
        });
        $( "#comparisontt-tab" ).click(function() {
            sessionStorage.setItem("TabName","importer_comparison");
            importer_comparison();
        });
        $( "#pricecompare-tab" ).click(function() {
            sessionStorage.setItem("TabName","importer_pricecompare");
    ...
    // Javascript method's body can be found in assets/js/demos.js
        ...
        $('#input-rtype').change(function(){
            ...
            if($(this).val() == 'Importer'){
                ...
                $('#dvDataTable').html('');
                $('#dvDataTable').html ('<table id="importer-table" class="table"><thead class=" text-primary"></thead></table>');
        ...
        $("#frm_filter").submit(function(event){
            ...
            if ('Importer' == $('#input-rtype').val()) {
                ...
                if(Tab_Name == 'importer_datatable'){
                 importer_datatable(form_data);
                }
                if(Tab_Name == 'importer_dashboard'){
                 importer_dashboard(form_data);
                }

                if(Tab_Name == 'importer_analysis'){
                    importer_analysis(form_data);
                }

                if(Tab_Name == 'importer_sup_analysis'){
                    importer_sup_analysis(form_data);
                }
                if(Tab_Name == 'importer_marketshare'){
                    importer_marketshare(form_data);
                }
                if(Tab_Name == 'importer_priceana'){
                    importer_priceana(form_data);
                }
                if(Tab_Name == 'importer_comparison'){
                    importer_comparison(form_data);
                }
                if(Tab_Name == 'importer_gridsummaries'){
                    importer_gridsummaries(form_data);
                }
                if(Tab_Name == 'importer_pricecompare'){
