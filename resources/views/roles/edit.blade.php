                        ...
                        <form method="post" action="{{ route('role.update', $role) }}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="description" id="input-description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __('Description') }}" value="{{ old('description', $role->description) }}" >
                                ...
                                <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="status" id="input-status" class="form-control{{ $errors->has('status') ? ' is-invalid' : '' }}" >
                                        ...
                                        <option value="Enable" {{  ("Enable" == old('status', $role->status))?'selected="selected"':'' }}>Enable</option>
                                        <option value="Disable" {{  ("Disable" == old('status', $role->status))?'selected="selected"':'' }}>Disable</option>
                                ...
                                <div class="form-group{{ $errors->has('order') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="order" id="input-order" class="form-control{{ $errors->has('order') ? ' is-invalid' : '' }}" placeholder="{{ __('Order') }}" value="{{ old('order', $role->order) }}">
